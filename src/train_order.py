...
def main():
    ...
    if cfg.logging.save_config_copy:
        save_config_snapshot(asdict(cfg), cfg.paths.runs_dir, cfg.logging.run_name_prefix + "_order")
    log.info("Loaded config; training ORDER model stub...")
    # TODO: implement training; use cfg.models['order']
